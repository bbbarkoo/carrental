...
<body>
      ...
      <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
        ...
        <div class="items-center justify-between w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
          <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
            ...
            <li>
              <a href="../vehicles2.php" class="block py-2 pl-3 pr-4 text-white bg-red-700 rounded lg:bg-transparent lg:text-black lg:hover:text-red-600 lg:p-0 dark:text-red-600" aria-current="page">Vehicles</a>
            </li>
            <li>
  ...
  $sql = "SELECT carID, carBrand, carModel, carYear, gearType, engineType, fuelType ,horsePower, carColor, price FROM Cars WHERE carID = 2"; // Assuming you want data for a specific vehicle ID
  ...
  <section class="vehicle-sec">
        ...
        <form action="../rent.php" method="post"><!--javascript:validateForm()    -->
          ...
          <div class="rent-container lg:flex flex-col">
            ...
            <div class="input-box mt-3">
              ...
              <input type="date" name="pickupdate" id="pickupdate" onchange="enableDropDate(); setMinDropDate(); cal()" required>
            </div>
            ...
            <script type="text/javascript">
              function carIDFinder() {
                ...
                document.getElementById('carID').value = 2;
                // Multiply it by 100
    ...
    <div class="form-container w-full">
      <div class="rent-container lg:flex flex-col mt-4">
        ...
        <p class="text-xl">&bull; <strong>Car Model : </strong>
          <?php echo $carBrand . ' ' . $carModel; ?>
        </p>
        <p class="text-xl">&bull; <strong>Year : </strong>
          <?php echo $carYear; ?>
        </p>
        <p class="text-xl">&bull; <strong>Gear Type : </strong>
          <?php echo $gearType; ?>
        </p>
        <p class="text-xl">&bull; <strong>Engine Type : </strong>
          <?php echo $engineType; ?>
        </p>
        <p class="text-xl">&bull; <strong>Fuel Type : </strong>
          <?php echo $fuelType; ?>
        </p>
        <p class="text-xl">&bull; <strong>Horse Power : </strong>
          <?php echo $horsePower; ?>
        </p>
        <p class="text-xl">&bull; <strong>Car Color : </strong>
          <?php echo $carColor; ?>
        </p>
      </div>
    </div>
