...
<body>
      ...
      <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
        ...
        <div class="items-center justify-between w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
          <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
            ...
            <li>
              <a href="../vehicles2.html" class="block py-2 pl-3 pr-4 text-white bg-red-700 rounded lg:bg-transparent lg:text-black lg:hover:text-red-600 lg:p-0 dark:text-red-600" aria-current="page">Vehicles</a>
            </li>
            <li>
  ...
  $sql = "SELECT carID, carBrand, carModel, carYear, gearType, engineType, fuelType ,horsePower, carColor, price FROM Cars WHERE carID = 3"; // Assuming you want data for a specific vehicle ID
      ...
      <div class="form-container basis-1/2 w-full">
        <form action="../rent.php" method="post">
          ...
          <div class="rent-container lg:flex flex-col ">
            ...
            <select class="pickuplocation mt-1.5" name="pickuplocation" id="pickuplocation">
            ...
            <div class="input-box mt-3">
              <span class="form-title">Drop Date:</span>
              <input type="date" name="dropdate" id="dropdate" onchange="cal(); calculatePrice(); carIDFinder()" disabled>
            </div>
            ...
            <script type="text/javascript">
              function carIDFinder() {
                ...
                document.getElementById('carID').value = 3;
                // Multiply it by 100
