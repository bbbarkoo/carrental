...
<body>
  ...
  $sql = "SELECT carID, carBrand, carModel, carYear, gearType, engineType, fuelType ,horsePower, carColor, price FROM Cars WHERE carID = 9"; // Assuming you want data for a specific vehicle ID
          ...
          <div class="rent-container lg:flex flex-col ">
            ...
            <script type="text/javascript">
              function carIDFinder() {
                ...
                document.getElementById('carID').value = 9;
                // Multiply it by 100
