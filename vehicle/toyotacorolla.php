...
<body>
  ...
  $sql = "SELECT carBrand, carModel, carYear, gearType, engineType, fuelType ,horsePower, carColor FROM Cars WHERE carID = 9"; // Assuming you want data for a specific vehicle ID
  ...
  session_start();
  $query3 = "SELECT filepath FROM Images WHERE carID = 9 AND filepath LIKE '%$carBrand%'AND NOT filepath LIKE '%png%'";
