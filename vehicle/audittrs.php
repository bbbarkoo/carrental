...
<body>
    ...
    <nav class="bg-white border-gray-200 py-2.5 dark:bg-gray-300">
      <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
        ...
        <div class="flex items-center lg:order-2">
          ...
          <a href="../login.html" class="text-white bg-red-700 lg:mr-3 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 dark:bg-blue-900 dark:hover:bg-red-700 focus:outline-none dark:focus:ring-red-800">Login</a>
          <a href="../signup.html" class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 dark:bg-red-600 dark:hover:bg-blue-900 focus:outline-none dark:focus:ring-red-800">Sign
            Up</a>
        ...
        <div class="items-center justify-between w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
          <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
            ...
            <li>
              <a href="../vehicles.php" class="block py-2 pl-3 pr-4 text-white bg-red-700 rounded lg:bg-transparent lg:text-black lg:hover:text-red-600 lg:p-0 dark:text-red-600" aria-current="page">Vehicles</a>
            </li>
            <li>
              <a href="../reservations.html" class="block py-2 pl-3 pr-4 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-red-700 lg:p-0 dark:text-black lg:dark:hover:text-red-600 dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Reservations</a>
            </li>
            <li>
  ...
  <?php include 'vehicleconndb.php';
    $sql = "SELECT carBrand, carModel, carYear, gearType, engineType, fuelType ,horsePower, carColor FROM Cars WHERE carID = 2"; // Assuming you want data for a specific vehicle ID
  ...
  session_start();
  $query3 = "SELECT filepath FROM Images WHERE carID = 2 AND filepath LIKE '%$carBrand%'AND NOT filepath LIKE '%png%'";
  ...
  <section class="vehicle-sec">
    ...
    <div class="lg:flex flex-row flex-wrap md:flex-nowrap justify-center gap-4 mt-3">
      ...
      <div class="form-container basis-1/2 w-full">
        <form onsubmit="return alertLogin()"><!--javascript:validateForm()    -->
          ...
          <div class="rent-container lg:flex flex-col ">
            ...
            <div class="input-box mt-3">
              ...
              <input type="date" name="dropdate" id="dropdate" disabled required>
            </div>

            <!-- <input type="submit" value="Rent" id="" class="btn">  -->
            <!-- <button class="btn" id="rentbutton">Rent</button> -->
            <input type="submit" value="Rent" id="rentbutton" class="btn cursor-pointer">
            </input>
...
<script>
  function alertLogin() {
    alert("YOU HAVE TO LOGIN TO RENT A CAR");
