...
<head>
  ...
  <title>Tesla Model S 2023</title>
...
<body>
      ...
      <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
        ...
        <div class="items-center justify-between w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
          <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
            ...
            <li>
              <a href="../vehicles.php" class="block py-2 pl-3 pr-4 text-white bg-red-700 rounded lg:bg-transparent lg:text-black lg:hover:text-red-400 lg:p-0 dark:text-red-600" aria-current="page">Vehicles</a>
            </li>
            <li>
  ...
  $sql = "SELECT carBrand, carModel, carYear, gearType, engineType, fuelType ,horsePower, carColor FROM Cars WHERE carID = 8"; // Assuming you want data for a specific vehicle ID
  ...
  session_start();
  $query3 = "SELECT filepath FROM Images WHERE carID = 8 AND filepath LIKE '%$carBrand%'AND NOT filepath LIKE '%png%'";
