    ...
    <div class="flex flex-col">
      ...
      <div id="nores" class="flex items-start justify-center pt-20 h-screen bg-gray-100" style="height: 100vh;">
        <div class="text-center">
          <h1 class="text-2xl font-bold mb-4">You do not have any reservations!</h1>
          <p class="mb-8">
            If you want rent a car please click the vehicles and choose car.
          </p>
        </div>
      </div>
      <div class="mt-10 grid lg:grid-cols-2 gap-x-8 gap-y-8 items-center">
        ...
        $query = "SELECT resID, carID, pickupLocation, dropLocation, pickupDate, dropDate FROM Reservations WHERE customerID = {$_SESSION['customerId']}";
        ...
        if (mysqli_num_rows($result) > 0) {
          ...
          while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "
          <a href='reservationdetails.php?id=$resID'>
            <div class='group group-hover:bg-opacity-60 transition duration-500 relative bg-gray-50 dark:bg-purple-900 dark:hover:bg-blue-700 sm:p-28 py-36 px-10 flex justify-center items-center'>
